...
// New returns a new in memory vm.storage.Store
...
// FindAnyWithAvailableCapacity implements vm.storage.Store.FindAnyWithAvailableCapacity
...
// ReserveStorage implements vm.storage.Store.ReserveStorage
