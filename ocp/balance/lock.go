...
// cached balance
func GetOptimisticVersionLock(ctx context.Context, data ocp_data.Provider, vault *common.Account) (*OptimisticVersionLock, error) {
...
// cached balance
func (l *OptimisticVersionLock) OnNewBalanceVersion(ctx context.Context, data ocp_data.Provider) error {
...
func (l *OptimisticVersionLock) RequireSameBalanceVerion(ctx context.Context, data ocp_data.Provider) error {
...
func (l *OpenCloseStatusLock) OnPaymentToAccount(ctx context.Context, data ocp_data.Provider) error {
...
func (l *OpenCloseStatusLock) OnClose(ctx context.Context, data ocp_data.Provider) error {
