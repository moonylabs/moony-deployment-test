...
func NewInitializeLockedTimelockAccountFulfillmentHandler(data ocp_data.Provider) FulfillmentHandler {
...
func NewNoPrivacyTransferWithAuthorityFulfillmentHandler(data ocp_data.Provider, vmIndexerClient indexerpb.IndexerClient) FulfillmentHandler {
...
func NewNoPrivacyWithdrawFulfillmentHandler(data ocp_data.Provider, vmIndexerClient indexerpb.IndexerClient) FulfillmentHandler {
...
func NewCloseEmptyTimelockAccountFulfillmentHandler(data ocp_data.Provider, vmIndexerClient indexerpb.IndexerClient) FulfillmentHandler {
...
func isAccountInitialized(ctx context.Context, data ocp_data.Provider, address string) (bool, error) {
...
func getFulfillmentHandlers(data ocp_data.Provider, vmIndexerClient indexerpb.IndexerClient) map[fulfillment.Type]FulfillmentHandler {
