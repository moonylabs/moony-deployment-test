...
func (p *runtime) validateFulfillmentState(record *fulfillment.Record, states ...fulfillment.State) error {
...
func (p *runtime) markFulfillmentPending(ctx context.Context, record *fulfillment.Record) error {
...
func (p *runtime) markFulfillmentConfirmed(ctx context.Context, record *fulfillment.Record) error {
...
func (p *runtime) markFulfillmentFailed(ctx context.Context, record *fulfillment.Record) error {
	err := p.validateFulfillmentState(record, fulfillment.StatePending)
	if err != nil {
		return err
	}
...
func (p *runtime) markFulfillmentRevoked(ctx context.Context, fulfillmentRecord *fulfillment.Record, nonceUsed bool) error {
...
func (p *runtime) sendToBlockchain(ctx context.Context, record *fulfillment.Record) error {
...
func (p *runtime) getTransaction(ctx context.Context, record *fulfillment.Record) (*transaction.Record, error) {
...
func (p *runtime) getTransactionFromBlockchain(ctx context.Context, record *fulfillment.Record) (*transaction.Record, error) {
...
func (p *runtime) markNonceAvailableDueToRevokedFulfillment(ctx context.Context, fulfillmentToRevoke *fulfillment.Record) error {
...
func (p *runtime) markNonceReleasedDueToSubmittedTransaction(ctx context.Context, fulfillmentRecord *fulfillment.Record) error {
...
// Important Note: Do NOT call this if the fulfillment being revoked is due to
// transactions having shared nonce blockhashes!
func (p *runtime) markVirtualNonceAvailableDueToRevokedFulfillment(ctx context.Context, fulfillmentToRevoke *fulfillment.Record) error {
	// We'll only automatically manage the nonce state if the fulfillment is in
	// an unknown state. Otherwise, there's a chance it was submitted and could
	// have been used. A human is needed to resolve it.
	if fulfillmentToRevoke.State != fulfillment.StateUnknown {
...
func (p *runtime) markVirtualNonceReleasedDueToSubmittedTransaction(ctx context.Context, fulfillmentRecord *fulfillment.Record) error {
	if fulfillmentRecord.State != fulfillment.StatePending {
		return errors.New("fulfillment is in unexpected state")
	}
...
func maybeCleanupAutoReturnAction(ctx context.Context, data ocp_data.Provider, vaultAddress string) error {
	...
	err = account_worker.InitiateProcessToCleanupGiftCardAutoReturn(ctx, data, vaultAccount)
	if err != nil {
		return err
	}
	...
	account_worker.MarkAutoReturnCheckComplete(ctx, data, accountInfoRecord)
