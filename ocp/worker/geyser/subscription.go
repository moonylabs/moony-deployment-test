...
func (p *runtime) subscribeToProgramUpdatesFromGeyser(ctx context.Context, endpoint, xToken string) error {
...
func (p *runtime) subscribeToSlotUpdatesFromGeyser(ctx context.Context, endpoint, xToken string) error {
