...
func (p *runtime) recordSubscriptionStatusPollingEvent(ctx context.Context) {
...
func (p *runtime) recordEventWorkerStatusPollingEvent(ctx context.Context) {
...
func (p *runtime) recordEventQueueStatusPollingEvent(ctx context.Context) {
...
func (p *runtime) recordBackupWorkerStatusPollingEvent(ctx context.Context) {
	p.metricStatusLock.Lock()
	defer p.metricStatusLock.Unlock()
