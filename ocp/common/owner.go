...
func GetOwnerMetadata(ctx context.Context, data ocp_data.Provider, owner *Account) (*OwnerMetadata, error) {
	mtdt := &OwnerMetadata{
		Account: owner,
	}
...
func GetOwnerManagementState(ctx context.Context, data ocp_data.Provider, owner *Account) (OwnerManagementState, error) {
...
func GetLatestTokenAccountRecordsForOwner(ctx context.Context, data ocp_data.Provider, owner *Account) (map[string]map[commonpb.AccountType][]*AccountRecords, error) {
...
func GetLatestCodeTimelockAccountRecordsForOwner(ctx context.Context, data ocp_data.Provider, owner *Account) (map[string]map[commonpb.AccountType][]*AccountRecords, error) {
	res := make(map[string]map[commonpb.AccountType][]*AccountRecords)
