...
func LoadProductionSubsidizer(ctx context.Context, data ocp_data.Provider) error {
...
func InjectTestSubsidizer(ctx context.Context, data ocp_data.Provider, testAccount *Account) error {
	subsidizerAccountLock.Lock()
	defer subsidizerAccountLock.Unlock()
...
func EstimateUsedSubsidizerBalance(ctx context.Context, data ocp_data.Provider) (uint64, error) {
	var fees uint64
...
func EnforceMinimumSubsidizerBalance(ctx context.Context, data ocp_data.Provider) error {
