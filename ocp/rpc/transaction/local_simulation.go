...
func LocalSimulation(ctx context.Context, data ocp_data.Provider, actions []*transactionpb.Action) (*LocalSimulationResult, error) {
...
func (s TokenAccountSimulation) EnforceBalances(ctx context.Context, data ocp_data.Provider, currentBalance uint64) error {
