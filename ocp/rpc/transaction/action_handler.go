...
func NewOpenAccountActionHandler(ctx context.Context, data ocp_data.Provider, protoAction *transactionpb.OpenAccountAction, protoMetadata *transactionpb.Metadata) (CreateActionHandler, error) {
...
func NewNoPrivacyTransferActionHandler(ctx context.Context, data ocp_data.Provider, protoAction *transactionpb.NoPrivacyTransferAction) (CreateActionHandler, error) {
	mint, err := common.GetBackwardsCompatMint(protoAction.Mint)
	if err != nil {
		return nil, err
	}
...
func NewFeePaymentActionHandler(ctx context.Context, data ocp_data.Provider, protoAction *transactionpb.FeePaymentAction, feeCollectorOwner *common.Account) (CreateActionHandler, error) {
	mint, err := common.GetBackwardsCompatMint(protoAction.Mint)
	if err != nil {
		return nil, err
	}
...
func NewNoPrivacyWithdrawActionHandler(ctx context.Context, data ocp_data.Provider, intentRecord *intent.Record, protoAction *transactionpb.NoPrivacyWithdrawAction) (CreateActionHandler, error) {
	mint, err := common.GetBackwardsCompatMint(protoAction.Mint)
	if err != nil {
		return nil, err
	}
